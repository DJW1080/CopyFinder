...
![Version \2.01.0](https://img.shields.io/badge/Version-2.1.0-yellow?logo=version "Version 2.1.0")
...
- Warns when files are on network or mapped drives as deletion may be final.
